...
def _generate_str_s3_object_keys(
        s3_paginator: botocore.paginate.Paginator,
        bucket_name: str,
...
def get_str_latest_scores_parquet_file_uri() -> str:
    ...
    # Get candidates
    candidates = [key for key in _generate_str_s3_object_keys(s3_paginator,
    ...
    try:
        ...
        raise FileNotFoundError("Could not find latest suitability score file automatically, please enter filepath manually.")
