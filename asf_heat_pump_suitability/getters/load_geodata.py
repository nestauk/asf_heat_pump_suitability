...
def load_gdf_heat_network_zones(local_authority: str, **kwargs) -> gpd.GeoDataFrame:
    ...
    print(f"Heat network zone geodataframe successfully loaded for {local_authority} with CRS {gdf.crs}.")
    return gdf
...
def load_gdf_spatial_signatures_gb(detail_level: str = "full", **kwargs) -> gpd.GeoDataFrame:
    ...
    print(f"Spatial signatures {detail_level} geodataframe successfully loaded with CRS {gdf.crs}.")
